...
describe "Exchange::ISO" do
  ...
  describe "self.round" do
    it "should round a currency according to ISO 4217 Definitions" do
      subject.round(BigDecimal("23.232524"), :tnd).should == BigDecimal("23.233")
      subject.round(BigDecimal("23.232524"), :sar).should == BigDecimal("23.23")
      subject.round(BigDecimal("23.232524"), :clp).should == BigDecimal("23")
    end
    it "should round psychologically if asked" do
      subject.round(BigDecimal("23.232524"), :tnd, nil, {:psych => true}).should == BigDecimal("22.999")
      subject.round(BigDecimal("23.232524"), :sar, nil, {:psych => true}).should == BigDecimal("22.99")
      subject.round(BigDecimal("23.232524"), :clp, nil, {:psych => true}).should == BigDecimal("19")
    end
  end
  describe "self.ceil" do
    it "should ceil a currency according to ISO 4217 Definitions" do
      subject.ceil(BigDecimal("23.232524"), :tnd).should == BigDecimal("23.233")
      subject.ceil(BigDecimal("23.232524"), :sar).should == BigDecimal("23.24")
      subject.ceil(BigDecimal("23.232524"), :clp).should == BigDecimal("24")
    end
    it "should ceil psychologically if asked" do
      subject.ceil(BigDecimal("23.232524"), :tnd, nil, {:psych => true}).should == BigDecimal("23.999")
      subject.ceil(BigDecimal("23.232524"), :sar, nil, {:psych => true}).should == BigDecimal("23.99")
      subject.ceil(BigDecimal("23.232524"), :clp, nil, {:psych => true}).should == BigDecimal("29")
    end
  end
  describe "self.floor" do
    it "should floor a currency according to ISO 4217 Definitions" do
      subject.floor(BigDecimal("23.232524"), :tnd).should == BigDecimal("23.232")
      subject.floor(BigDecimal("23.232524"), :sar).should == BigDecimal("23.23")
      subject.floor(BigDecimal("23.232524"), :clp).should == BigDecimal("23")
    end
    it "should floor psychologically if asked" do
      subject.floor(BigDecimal("23.232524"), :tnd, nil, {:psych => true}).should == BigDecimal("22.999")
      subject.floor(BigDecimal("23.232524"), :sar, nil, {:psych => true}).should == BigDecimal("22.99")
      subject.floor(BigDecimal("23.232524"), :clp, nil, {:psych => true}).should == BigDecimal("19")
    end
  end
  ...
  describe "self.stringify" do
    it "should stringify a currency according to ISO 4217 Definitions" do
      subject.stringify(BigDecimal("23234234.232524"), :tnd).should == "TND 23234234.233"
      subject.stringify(BigDecimal("23234234.232524"), :sar).should == "SAR 23,234,234.23"
      subject.stringify(BigDecimal("2323434223.232524"), :clp).should == "CLP 2.323.434.223"
      subject.stringify(BigDecimal("232344.2"), :tnd).should == "TND 232344.200"
      subject.stringify(BigDecimal("233432434.4"), :sar).should == "SAR 233,432,434.40"
      subject.stringify(BigDecimal("23234234.0"), :clp).should == "CLP 23.234.234"
    end
    context "amount only" do
      it "should not render the currency" do
        subject.stringify(BigDecimal("23.232524"), :tnd, :format => :amount).should == "23.233"
        subject.stringify(BigDecimal("223423432343.232524"), :chf, :format => :amount).should == "223'423'432'343.23"
        subject.stringify(BigDecimal("23.232524"), :clp, :format => :amount).should == "23"
        subject.stringify(BigDecimal("23.2"), :tnd, :format => :amount).should == "23.200"
        subject.stringify(BigDecimal("25645645663.4"), :sar, :format => :amount).should == "25,645,645,663.40"
        subject.stringify(BigDecimal("23.0"), :clp, :format => :amount).should == "23"
      end
    end
    context "plain amount" do
      it "should not render the currency or separators" do
        subject.stringify(BigDecimal("23.232524"), :tnd, :format => :plain).should == "23.233"
        subject.stringify(BigDecimal("223423432343.232524"), :chf, :format => :plain).should == "223423432343.23"
        subject.stringify(BigDecimal("23.232524"), :clp, :format => :plain).should == "23"
        subject.stringify(BigDecimal("23.2"), :tnd, :format => :plain).should == "23.200"
        subject.stringify(BigDecimal("25645645663.4"), :sar, :format => :plain).should == "25645645663.40"
        subject.stringify(BigDecimal("23.0"), :clp, :format => :plain).should == "23"
      end
    end
    context "symbol" do
      context "with a symbol present" do
        it "should render a symbol for the currency" do
          subject.stringify(BigDecimal("23.232524"), :usd, :format => :symbol).should == "$23.23"
          subject.stringify(BigDecimal("23.232524"), :irr, :format => :symbol).should == "﷼23.23"
          subject.stringify(BigDecimal("345543453453.232524"), :gbp, :format => :symbol).should == "£345,543,453,453.23"
          subject.stringify(BigDecimal("23.232524"), :eur, :format => :symbol).should == "€23.23"
        end
      end
      context "without a symbol present" do
        it "should render the currency abbreviation" do
          subject.stringify(BigDecimal("32741393.232524"), :chf, :format => :symbol).should == "CHF 32'741'393.23"
          subject.stringify(BigDecimal("23.232524"), :etb, :format => :symbol).should == "ETB 23.23"
        end
      end
    end
  end
